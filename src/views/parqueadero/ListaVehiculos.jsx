        ...
        <CCardBody>
          ...
          {loading ? (
            <div className="text-center my-5">
              ...
              <p className="mt-2 text-muted">Cargando vehículos desde Supabase...</p>
            </div>
          ) : (
                    ...
                    <CTableRow key={item.id}>
                      ...
                      <CTableDataCell className="text-center">
                        <CImage
                          ...
                          alt="Vehículo"
                          onError={(e) => {
                            e.target.src = 'https://via.placeholder.com/60x40?text=Auto'
                          }}
                        />
                      </CTableDataCell>
                      ...
                      <CTableDataCell>
                        <div>
                          <strong>{item.marca}</strong> {item.modelo} ({item.anio})
                        </div>
                        <div className="small text-muted">
                          Color: {item.color} | Tipo: {item.tipo}
                        </div>
                      </CTableDataCell>

  ...
  >
    ...
    <g fill="none" fillRule="evenodd">
      ...
      <g fontFamily="Arial, Helvetica, sans-serif">
        ...
        <text x="156" y="87" fill="#FFFFFF" fontSize="16" fontWeight="800" textAnchor="middle" letterSpacing="1">
          UTEQ
        </text>
        <text x="196" y="87" fill="currentColor" fillOpacity="0.72" fontSize="14" fontWeight="600" letterSpacing="1.1">
